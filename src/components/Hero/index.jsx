  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto">
        <p className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 uppercase tracking-wider mb-6 text-5xl font-semibold">
          Миний вэбед тавтай морил!
        </p>

        <h1 className="mb-8">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">
            Орчин үеийн технологиудыг
          </span>
          <span className="block text-white">
            төсөлдөө хэрэгжүүлэхийг эрмэлздэг
          </span>
        </h1>

        <p className="text-slate-300 mb-12 max-w-2xl mx-auto">
          Сайн уу! Намайг Энхбаяр гэдэг веб хөгжүүлэгч мэргэжилтэй. Одоогоор ур
          чадвараа ахиулж, сонирхолтой төслүүдэд оролцож дадлага туршлага
          хуримтлуулах боломжийг эрэлхийлж байна.
        </p>
